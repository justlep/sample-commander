import {app, shell, BrowserWindow, nativeImage, ipcMain, protocol} from 'electron'
import {
...
function createMainWindow() {
    ...
    const APP_URL = IS_DEV ? 'http://localhost:9080' : `file://${__dirname}/index.html`;
...
//app.on('activate', createMainWindow); // macOS

app.once('window-all-closed', () => (process.platform !== 'darwin') && app.quit());
