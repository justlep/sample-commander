    ...
    export default {
        ...
        methods: {
            showMenu({fileItem, canSelectAll, canDeselectAll, selectedFileItems}) {
                ...
                let menu = new Menu(),
                    fileFolderPath = path.resolve(fileItem.path, '..'),
                ...
                menu.append(new MenuItem({
                    ...
                    click: () => shell.openItem(fileItem.path)
                }));
                ...
                menu.append(new MenuItem({
                    ...
                    submenu: ((subMenu) => {
                        ...
                        subMenu.append(new MenuItem({
                            ...
                            click: () => this.$emitGlobal('show-delete-dialog', {fileItems: itemSelection, spectrogramsOnly: true})
                        }));
